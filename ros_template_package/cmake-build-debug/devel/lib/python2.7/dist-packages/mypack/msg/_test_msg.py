...
"""autogenerated by genpy from mypack/test_msg.msg. Do not edit."""
import sys
...
class test_msg(genpy.Message):
  _md5sum = "e7da32a6e4d8484cb0ce2df006bb412f"
  _type = "mypack/test_msg"
...
float64 y
float64 z"""
  __slots__ = ['header','data','twist']
  _slot_types = ['std_msgs/Header','int32[]','geometry_msgs/Twist']
